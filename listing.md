...
1. Fork the [RobustSwap Dex Frontend](https://github.com/robustswap/robust-frontend-dex/) repository on GitHub
...
3. Add your **token information** using the example format provided below to `robustswap.json` in the `/src/constants/token/` directory.
...
"chainId": 56,
"decimals": 18,
"logoURI": "/images/coins/RBT.png"
},
```

If you're not comfortable with GitHub pull requests, please open a [new issue](https://github.com/robustswap/robust-frontend-dex/issues/new) requesting to be added.
