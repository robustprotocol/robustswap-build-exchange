...
import { CardBody, ArrowDownIcon, Button, IconButton, Text } from '@robustswap-libs/uikit'
                ...
                <Card padding=".25rem .75rem 0 .75rem" borderRadius="20px">
                  <AutoColumn gap="4px">
                    <RowBetween align="center">
                      <Text fontSize="14px" color="#A0B9FB">Price</Text>
                      <TradePrice
                    ...
                    <RowBetween align="center">
                      <Text fontSize="14px" color="#A0B9FB">Slippage Tolerance</Text>
