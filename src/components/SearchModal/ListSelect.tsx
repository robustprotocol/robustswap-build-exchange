...
import { Button, Text, ChevronDownIcon } from '@robustswap-libs/uikit'
      ...
      <StyledMenu ref={node as any}>
        ...
        {open && (
          <PopoverContainer show ref={setPopperElement as any} style={styles.popper} {...attributes.popper}>
            ...
            <SeparatorDark />
            <ExternalLink href={`https://bsctokenlists.org//token-list?url=${listUrl}`}>View list</ExternalLink>
  ...
  return (
    <Column style={{ width: '100%', flex: '1 1' }}>
      <PaddedColumn>
        <RowBetween>
          <div>
            <ArrowLeft style={{ cursor: 'pointer', color: 'white' }} onClick={onBack} />
          </div>
          <Text fontSize="20px">Manage</Text>
      ...
      <div style={{ padding: '16px', textAlign: 'center' }}>
        <ExternalLink href="https://bsctokenlists.org">Browse lists</ExternalLink>
      </div>
    </Column>
  )
}
